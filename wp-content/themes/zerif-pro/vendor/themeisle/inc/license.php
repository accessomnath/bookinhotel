...
if ( ! class_exists( 'THEMEISLE_LICENSE' ) ) :
	...
	class THEMEISLE_LICENSE extends THEMEISLE_SDK {
		...
		public function __construct( $product_name, $product_slug, $product_version, $product_type, $paid, $store_url, $product_data ) {
					...
					if ( $this->check_hide( 'activation' ) ) {
						...
						<div class="error">
							<p><strong>No activations left for <?php echo $this->product_name; ?> !!!. You need to
									...
									websites. Please <a href="mailto:friends@themeisle.com">contact</a> the ThemeIsle
...
<!--									href="https://themeisle.com/purchase-history">themeisle.com</a> and validate it <a-->
					...
					if ( $this->check_hide( 'expiration' ) ) {
						...
						<div class="update-nag">
							<p><strong>Your license is about to expire
									...
									You can go to <a
										href=<?php echo $this->renew_url(); ?>" >themeisle.com</a> and  renew it.</strong>| <a href="
